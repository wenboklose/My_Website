...
* Inverter Level 2 model -- an EMT (Electromagnetic Transient) model. This model represents the whole inverter by its full differential equations. Most power converter circuit simulations done by SIMPLIS, PLECS, PSim, Matlab/Simulink are EMT model simulations.
...
|Level 2| ![SIMPLIS MOSFET Level 2 Model](img/simplis_mosfet_level_2_schematic.png){width=80%} | ![Inverter Level 2 Model](img/Inverter_Level_1.png) |
